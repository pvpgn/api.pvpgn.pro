...
namespace CharacterEditor.ResourceModels
{
    public class Weapons
    {
        ...
        [Name("1or2handed")]
        public string oneortwohanded { get; set; }
        [Name("2handed")]
        public string twohanded2 { get; set; }
        [Name("2handmindam")]
        public string twohandmindam { get; set; }
        [Name("2handmaxdam")]
        public string twohandmaxdam { get; set; }
        public string minmisdam { get; set; }
        public string maxmisdam { get; set; }
        //public string  { get; set; } // empty column
